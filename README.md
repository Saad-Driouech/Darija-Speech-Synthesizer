...
5- Perform alignment  
You will need to install HTK aligner on a linux machine. [Steps to install linux on Ubuntu](https://gist.github.com/laic/39b8b2e156c39c778888aa825aee9877).  
After successful installation, you will need to create a folder for your data which will contain the lab and wav files (each lab file contains transcript of one audio). You will also need the dictionary as output by the aligner. The next step is to run the following command: _python3 -m aligner -r lang-mod.zip -a data/ -d lang.dict_ where:  
